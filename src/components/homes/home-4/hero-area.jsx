                  ...
                  <div className="row">
                     <div className="col-xl-7 col-lg-7">
                        <div className="tp-hero-4-section-box pt-10 z-index-3">
                           <span className="tp-section-subtitle-4 d-inline-block tp-char-animation wow tpfadeRight" name="main-subtitle" data-wow-duration="1s" data-wow-delay=".6s">{sub_title}</span>
                           <h1 className="tp-hero-title-5 fw-bolder pb-10 tp-char-animation" name="main-title">{title}</h1>
                           <p className='pb-35 tp-fun-fact-title fw-normal' name="lead-content">{description}</p>
                     ...
                     <div className="col-xl-5 col-lg-5">
                        <div className="tp-hero-4-img-wrapper p-relative">
                           <div className='custom-pill'>
                              <span className='pill-text' name="live-pill-text">Setoo AI will be Live Soon ✨</span>
