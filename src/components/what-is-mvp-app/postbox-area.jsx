...
const post_box_content = {
    title_1: <>What is MVP App and How It Drives Business Growth!</>,
    des_1: <>MVP stands for Minimum viable product in the context of application development. It's a basic concept in software development process that focuses on building a beta version of application with minimal features to satisfy early users to get the valuable feedback before going further for full product.</>,
    des_2: <>An MVP app's primary purpose is to quickly provide a functional product to the market or target audience, learn from user interactions, and iterate and improve based on that feedback.</>,
    title_2: "How to Update your Theme",
    des_3: <>It's a critical step in product development cycle, allowing developers and businesses to validate their ideas and build successful, user-centric applications over time. These days, corporate companies are talking about lean apps. An MVP came from there.</>,
    des_4: <>In short, if we sum up the answer of What is an MVP app in one line it would be like this -</>,
                           ...
                           <div className="postbox__details-qoute mb-30">
                              <blockquote className="d-flex align-items-start">
                                 ...
                                 <div className="postbox__details-qoute-text">
                                    <p>“An MVP app is strategic approach to app development that emphasizes on simplicity, speed, user feedback and iterative improvement.</p>
                                    <span>Socrates</span>
                                 </div>
                              </blockquote>
                           </div>
