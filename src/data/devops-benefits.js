...
const  service_data = [
    {
        ...
        description: <>Software updates and features are deployed at a faster pace.</>,
        delay: ".4s",
    },
    {
        id: 2,
        ...
        description: <>The efficacy is increased with increasing workloads and growth.</>,
        delay: ".6s",
    },
    {
        id: 3,
    ...
    },
    {
        ...
        description: <>Increasing the efficiency of software with continuous testing and monitoring.</>,
        delay: ".8s",
    },
    {
        id: 5,
        ...
        description: <>Reducing risks by taking proactive measures to protect applications and data.</>,
        delay: ".9s",
    },
]
