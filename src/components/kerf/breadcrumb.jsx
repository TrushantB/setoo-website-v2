...
const our_service = [
    ...
    },
    {
        ...
        cls: "space-left-2",
        title: "Services",
       description: <>E-COMMERCE, UI UX DESIGN</>
    },
    {
        id: 3, 
        cls: "space-left-3",
                        ...
                        <div className="col-xl-12">
                           <div className="breadcrumb__content z-index-3 mb-60">
                              <div className="breadcrumb__text wow tpfadeIn" name="breadcrumb-category" data-wow-duration=".9s" data-wow-delay=".6s">
                               <span>E-Commerce, UI/UX Design</span>
                              </div>
                              <h3 ref={animeRef} className="breadcrumb__title anime_text" name="breadcrumb-title">KERF</h3>
                           </div>
                        </div>
                     </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 mb-40 pd-border-right">
                           <div className="breadcrumb__client-info space-left-4">
                              ...
                              <div className="breadcrumb__live-btn">
                               <Link className="tp-btn-inner-border" href="https://www.kerf.works/" target="_blank">
                                    See live 
