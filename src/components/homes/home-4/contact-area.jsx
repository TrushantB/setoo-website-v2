         ...
         <div className="tp-contact-area tp-contact-overlay pt-120 pb-120 blue-bg z-index p-relative fix">
            ...
            <div className="container">
               <div className="row">
                  ...
                  <div className="col-xl-12 col-12 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".5s">
                     ...
                     <div className="d-flex flex-column align-items-center">
                        <h2 className="h4 fw-normal">Have a Great Idea in Mind?</h2>
                        <Link href="#" className="display-1">Let's Talk
